...
function BridgeJSRuntimeTests_runJsWorks(instance, exports) {
    ...
    // @JS protocol refinement: one JS object satisfies the refined protocol
    // and both of its parents; the Swift side reads inherited members and
    // writes the inherited settable one.
