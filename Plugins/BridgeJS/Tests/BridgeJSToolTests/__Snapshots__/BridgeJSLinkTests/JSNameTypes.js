...
export async function createInstantiator(options, swift) {
    ...
    return {
        ...
        addImports: (importObject, importsContext) => {
            ...
            importObject["TestModule"]["bjs_SwiftBox_wrap"] = function(pointer) {
                const obj = _exports['PublicBox'].__construct(pointer);
        ...
        createExports: (instance) => {
            ...
            class PublicBox extends SwiftHeapObject {
                static __construct(ptr) {
                    return SwiftHeapObject.__wrap(ptr, instance.exports.bjs_SwiftBox_deinit, PublicBox.prototype, null);
                }

                constructor() {
                    const ret = instance.exports.bjs_SwiftBox_init();
                    return PublicBox.__construct(ret);
                }
                copy() {
                    const ret = instance.exports.bjs_SwiftBox_copy(this.pointer);
                    return PublicBox.__construct(ret);
                }
            }
            const exports = {
                renamedChoice: function bjs_renamedChoice(value) {
                    const ret = instance.exports.bjs_renamedChoice(value);
                    return ret;
                },
                PublicChoice: PublicChoiceValues,
                PublicBox,
            };
            _exports = exports;
            return exports;
