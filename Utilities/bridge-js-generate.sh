...
./Plugins/BridgeJS/.build/debug/BridgeJSTool generate --project ./tsconfig.json --module-name BridgeJSSwiftIdentityTests --target-dir ./Tests/BridgeJSSwiftIdentityTests --output-dir ./Tests/BridgeJSSwiftIdentityTests/Generated
